// cmoc --srec --org=0000 --data=1000 --void-target keypadascii.c 
...
int main()
{
    ...
    while (1) {
        keyPressed=GetKey();
        ClearDisplay();
        unsigned char keyCharLookup[0x36]={'5','8','2','A','7','L',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','6','9','3','B','4','S',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','F','E','0','C','1','N',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','R','M','I','D',' ','G'};
        int keyIndex = (int) keyPressed;
        asciiKey = keyCharLookup[keyIndex];
        DisplayHex(asciiKey,0);
