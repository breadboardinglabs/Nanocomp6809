;C:\Users\Dave\OneDrive\Documents\_6809\asm6809-2.12-w64\asm6809.exe -B -l nanocomp_6809_v2_doc.txt nanocomp_6809_v2_doc.asm -o nanocomp_6809_v2_doc.bin
...
;
; Nanocomp 6809 Monitor V2 with MC6850 ACIA and Motorola SREC Load and Save
;
...
SERIALCTRL                    EQU  $5000           ; Use DP $50   $5000
SERIALSTATUS                  EQU  $5000           ; Use DP $50   $5000
SERIALDATA                    EQU  $5001           ; Use DP $50   $5001
...
DISP2                stb      PORTB             ; Select segment on Port B (04-09)            
                     lda      ,x+               ; Get segment value from Display buffer
...
;   Reset, NMI and SWI are defined by default, others need to be set first
                     FDB  SWI3INTR     ; SWI3 $7F, $D5     ; <$7FF2>

                     FDB  SWI2INTR     ; SWI2 $7F, $D0     ; <$7FF4>

                     FDB  FIRQINTR     ; FIRQ $7F, $DA     ; <$7FF6>

                     FDB  INTRQ        ; IRQ $7F, $DF      ; <$7FF8>

SWINTR               FDB  REGDISPSWI   ; SWI $7D, $F4      ; <$7FFA>

                     FDB  NMINTR       ; NMI $7F, $E4      ; <$7FFC>

RESETBOOT            FDB  RESET        ; RESET $7D, $89    ; <$7FFE>
